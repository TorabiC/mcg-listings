/**
 * MCG Admin Hub — Webflow Page Script
 *
 * Paste the contents of this file into the Webflow Designer:
 *   Pages → Admin Hub → Page Settings → Custom Code → Before </body> tag
 *
 * Before pasting, update API_URL below to your Railway deployment URL.
 */
